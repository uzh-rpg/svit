...
from .base.evo_deit import EvoVisionTransformer
...
class EvoViTAdapter(EvoVisionTransformer):
    def __init__(self, pretrain_size=224, num_heads=12, conv_inplane=64, n_points=4, deform_num_heads=6,
        ...
        self.interactions = nn.Sequential(*[
            InteractionBlockForEvo(dim=embed_dim, num_heads=deform_num_heads, n_points=n_points,
    ...
    def forward(self, x):
        ...
        for i, layer in enumerate(self.interactions):
            ...
            cls_token, x, c, cls_attn = layer(cls_token, x, c, indexes, self.blocks[indexes[0]:indexes[-1] + 1],
